    ...
    var Controller = {
        index: function () {
            ...
            $('.orders').click(function () {
                ...
                Backend.api.addtabs("order")
            })

            $(document).ready(function () {
                let isAudioEnabled = false;
                let previousNotificationCount = 0; // 记录上一次的通知数量

                // 激活音频播放权限
                document.addEventListener('click', function enableAudio() {
                    var audio = new Audio('/assets/new_order.mp3');
                    audio.play().then(() => {
                ...
                function playNotificationSound() {
                    ...
                    var audio = new Audio('/assets/new_order.mp3'); // 替换为你的 MP3 文件路径
